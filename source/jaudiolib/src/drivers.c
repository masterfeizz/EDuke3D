...
#elif defined _3DS
    {
    CTRDrv_GetError, CTRDrv_ErrorString, CTRDrv_PCM_Init, CTRDrv_PCM_Shutdown,
    CTRDrv_PCM_BeginPlayback, CTRDrv_PCM_StopPlayback, CTRDrv_PCM_Lock, CTRDrv_PCM_Unlock,
    },
#endif
};
